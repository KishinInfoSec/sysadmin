#!/usr/bin/env bash
# Purpose: Ensure strong ciphers are used for SSH connections
_Ciphers='chacha20-poly1305@openssh.com,aes128-gcm@openssh.com,aes256-gcm@openssh.com,aes128-ctr,aes192-ctr,aes256-ctr'
_KexAlgorithms='curve25519-sha256@libssh.org,ecdh-sha2-nistp256,ecdh-sha2-nistp384,ecdh-sha2-nistp521,diffie-hellman-group-exchange-sha256'
...
backup_file() {
    ...
    local file_source=$1
    # Get number of backups to keep from arg. default to 3
